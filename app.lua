...
-- the dot dot sign is the sane as "+" is JS and "." in PHP
...
```lua
local x = 10
if x == 10 and x < 0 then --both are true (it is the same as &&)
  print("dog")
elseif x == 100 or x < 0 then --1 or more are true (it is the same as ||)
  print("cat")
end
--result: cat
```
